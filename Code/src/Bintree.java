    ...
    public boolean deleteNode(int key)
    {
        ...
        if (succ == null){
            ...
            if(node.getKey() < root.getKey()) {
                ...
                node.getRight().setLeft(succ.getRight());
                succ.setRight(null);
                succ.setRight(root.getRight());
                succ.setLeft(root.getLeft());
                ...
                if(succ.getRight() == null && succ.getLeft() == null) {
                    node.getParent().replaceChild(node, succ);
                    succ.setLeft(node.getLeft());
                    return true;
                }
